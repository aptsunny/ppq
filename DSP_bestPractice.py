# ------------------------------------------------------------
# MFNR 最佳实践示例工程，在这个工程中，我们将向你展示如何充分调动 PPQ 的各项功能
# ------------------------------------------------------------
import torch
from ppq import *
from ppq.api import *
from mfnr_exp.mfnr_net import DualBranchUnet_v43, DualBranchUnet_v43_addConv2
from mfnr_exp.mfjddunet_arch_150ms import DualBranchUnet_v51
...
dispatch_nodes = fileio.load('mfnr_exp/modelv5_dispatch.yaml')
if dispatch_nodes:
...
u16_nodes = fileio.load('mfnr_exp/modelv5_all_u16.yaml')
...
# DualBranchUnet_v51
model = DualBranchUnet_v51(deploy1=True, deploy2=True, tail_conv=2)
